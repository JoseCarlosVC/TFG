    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-6 col-md-6">
                ...
                <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Calle falsa, 123</p>
                <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+34 600 00 00 00</p>
                <p class="mb-2"><i class="fa fa-envelope me-3"></i>9705@iespuertasdelcampo.es</p>
                <div class="d-flex pt-2">
                    ...
                    <a class="btn btn-square" href="https://www.youtube.com/"><i class="fab fa-youtube"></i></a>
